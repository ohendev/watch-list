...
titanicFirstListBookmark = Bookmark.create(comment: 'my first list with Titanic', list: myFirstList, movie: titanic)
shawshankFirstListBookmark = Bookmark.create(comment: 'my first list with Titanic', list: myFirstList, movie: shawshankRedemption)
myFirstList.save!